...
**执行前，读取以下输入文件：**
- `docs/requirements/backlog/REQ-XXXXXXXX.md`（需求文档，验收标准来源）
- `docs/design/REQ-XXXXXXXX-design.md`（技术设计文档，若 M/L/XL 等级）
- `docs/design/REQ-XXXXXXXX-code-report.md`（编码完成报告，含前后端生成文件清单）
- 编码完成报告中列出的所有源代码文件
